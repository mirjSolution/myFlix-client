...
export function ProfileView(props) {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(`https://myflix3.herokuapp.com/users/${props.user}`, {
        username: user,
        password: password,
        email: email,
        birthday: birthday,
  ...
  const handleUnregister = (e) => {
    ...
    if (confirm('Are you sure you want to unregister?')) {
      axios
        .delete(`https://myflix3.herokuapp.com/users/${props.user}`)
        .then(() => {
          localStorage.clear();
  ...
  const handleRemoveMovie = (movie) => {
    ...
    if (confirm(`Are you sure you want to remove this ${movie}?`)) {
      axios
        .delete(
          `https://myflix3.herokuapp.com/users/${props.user}/movies/${movie}`
        )
        .then(() => {
